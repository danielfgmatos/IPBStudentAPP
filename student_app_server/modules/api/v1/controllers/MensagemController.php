...
class AvisoController extends ActiveController
{
    ...
    public function actionGetAviso( $codigo_disciplina, $sessionCookie)
    {
        ...
        try {
            ...
            curl_setopt($ch, CURLOPT_COOKIE, "JSESSIONID=$sessionCookie");
            ...
            foreach ($html->find('td[headers="author"]') as $author) {
                ...
                array_push($authors, trim(strip_tags($author)));
            ...
            foreach ($links as $link) {
                ...
                try {
                    ...
                    curl_setopt($ch2, CURLOPT_COOKIE, "JSESSIONID=$sessionCookie");
